...
interface BadgeProps {
  ...
  color?: 'blue' | 'green' | 'orange' | 'red' | 'purple' | 'cyan' | 'warning' | 'success' | 'error';
}
...
const colorMap: Record<string, { bg: string; text: string; border: string }> = {
  ...
  success: { bg: 'rgba(16, 185, 129, 0.15)', text: 'var(--success-color)', border: 'var(--success-color)' },
  orange: { bg: 'rgba(245, 158, 11, 0.15)', text: 'var(--warning-color)', border: 'var(--warning-color)' },
  warning: { bg: 'rgba(245, 158, 11, 0.15)', text: 'var(--warning-color)', border: 'var(--warning-color)' },
  red: { bg: 'rgba(239, 68, 68, 0.15)', text: 'var(--error-color)', border: 'var(--error-color)' },
  error: { bg: 'rgba(239, 68, 68, 0.15)', text: 'var(--error-color)', border: 'var(--error-color)' },
