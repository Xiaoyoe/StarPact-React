...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ollama::ollama_get_models_with_addr,
            commands::ollama::ollama_pull_model,
            commands::ollama::ollama_pull_model_with_addr,
            commands::ollama::ollama_delete_model,
            commands::ollama::ollama_delete_model_with_addr,
            commands::ollama::ollama_chat,
            commands::ollama::ollama_show_model,
            commands::ollama::ollama_show_model_with_addr,
            commands::ollama::ollama_run_model,
            commands::ollama::ollama_run_model_with_addr,
            commands::ollama::ollama_stop_model,
            commands::ollama::ollama_stop_model_with_addr,
            commands::ollama::ollama_ps,
            commands::ollama::lmstudio_check_status,
            commands::ollama::lmstudio_get_models,
            commands::ollama::lmstudio_get_models_with_addr,
            commands::ollama::check_local_service,
            commands::ollama::stream_ollama_chat,
            commands::ollama::stream_remote_chat,
            commands::ollama::test_ollama_connection,
            commands::ollama::test_remote_connection,
            ...
            commands::storage::get_data_folder_structure,
            commands::storage::export_data,
            commands::storage::import_data,
            ...
            commands::lan_server::start_lan_server,
            commands::lan_server::stop_lan_server,
            commands::lan_server::get_lan_server_status,
        ])
